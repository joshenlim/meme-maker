  ...
  return (
    ...
    >
      <div className="mt-2 relative">
        <p>
          <Typography.Text>
            We provide a very simple interface to create memes quickly. You can:
          </Typography.Text>
        </p>
        <ul className="list-disc text-white pl-6 my-2">
          ...
          <li>
            <Typography.Text>
              Change your meme template easily if you're not feeling it
            </Typography.Text>
          </li>
        </ul>
        <p>
          <Typography.Text>
            Once your meme is good to go, you can either save it to view on this app, or export it
            directly to PNG
          </Typography.Text>
        </p>
        <p className="mt-4">
        ...
        <p>
          <Typography.Text>
            ...
            <a
              ...
              href="https://github.com/joshenlim"
              target="_blank"
            >
              joshenlim
            </a>
        ...
        <p
          className={`text-white absolute right-0 translate-x-36 transition rotate-12 ${
            loadAnimations ? 'opacity-100 -translate-y-28' : 'opacity-0 -translate-y-20'
          }`}
          style={{
            fontFamily: 'Impact',
